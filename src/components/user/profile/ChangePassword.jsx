...
export default function ChangePassword({ setChangePassword }) {
  ...
  return (
    <div className="flex flex-col items-center bg-transparent-white p-12 rounded-lg md:mx-0 md:w-[400px]">
      ...
      >
        <input
          className={`px-4 py-2 rounded text-sm md:text-lg placeholder:text-font-gray text-font-gray ${errors?.password}`}
          type="password"
          name="password"
          placeholder="old password"
        />
        {errors?.password && (
          <span className="text-xs md:text-md -mt-3 md:-mt-5 -mb-2 text-red-400">
            {errors.password_msg}
          </span>
        )}

        <input
          className={`px-4 py-2 rounded text-sm md:text-lg placeholder:text-font-gray text-font-gray ${errors?.new_password}`}
          type="password"
          name="new_password"
          placeholder="new password"
        />
        {errors?.new_password && (
          <span className="text-xs md:text-sm -mt-3 md:-mt-5 -mb-2 text-red-400">
            {errors.new_password_msg}
          </span>
        )}

        <input
          className={`px-4 py-2 rounded text-sm md:text-lg placeholder:text-font-gray text-font-gray ${errors?.confirm_password}`}
          type="password"
        ...
        <button className="border-2 text-sm md:text-lg rounded-lg bg-black text-white p-2">
          change password
        </button>
